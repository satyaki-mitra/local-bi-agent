...
class HealthMCPServer(BaseMCPServer):
    """
    MCP server for Health database
    """
    def __init__(self):
        super().__init__(host        = settings.db_health_host,
...
async def handle_mcp_request(request):
    try:
        ...
        logger.error("Unhandled MCP error", server = "health-mcp", error = str(e))
